...
public class Main extends Application
{
    ...
    @FXML
    private Button joinButton, connectButton, submitButton, startButton;
    @FXML
    private TextField ipField, portField, nameField;
    @FXML
    private Label joinPlayerOneTF;
    @FXML
    private Label hostPlayerOneTF;
    ...
    //What happens when different buttons are pressed.
    @FXML
    private void handleButtonPresses(ActionEvent event) throws Exception
    {
        ...
        if(event.getSource() == submitButton)
        {
            ...
            hostPlayerOneTF.setText(clientName);

            if (!isHost)
            {
                stage = (Stage) joinPlayerOneTF.getScene().getWindow();
            ...
            if (isHost)
            {
                System.out.println("loading host page");
    ...
    //A method that sets the Socket to the parsed socket.
    public void setSocket(Socket socket)
    {clientSocket = socket;}

    //A method for sending the name input through the data output streams.
    ...
    //Set one of the labels to the name
    public void setHostPlayerOneTF(String name)
    {hostPlayerOneTF.setText(name);}
}